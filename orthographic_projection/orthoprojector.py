...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Orthographic Projection of Point Cloud')
    parser.add_argument('--pcd', type=str, default='hmls_01.ply', help='Path to the point cloud file')
    ...
    np.save("ref_width.npy", ref_width)
    np.save("ref_height.npy", ref_height)
